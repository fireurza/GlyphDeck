# GlyphDeck Milestone 9 smoke test runner
...
Write-Host "=== GlyphDeck M9 User Terminal Smoke ==="
...
Write-Host "[harness] Starting M9 dev servers..."
& (Join-Path $scriptDir "start-dev-m9.ps1")
$cs = Join-Path $scriptDir "m9-smoke.cjs"
$rs = Join-Path $scriptsRuntimeDir "m9-smoke.cjs"
...
& (Join-Path $scriptDir "stop-dev-m9.ps1")
