# GlyphDeck Milestone 11 smoke test runner
...
Write-Host "=== GlyphDeck M11 SQLite Persistence Smoke ==="
...
Write-Host "[harness] Starting M11 dev servers..."
& (Join-Path $scriptDir "start-dev-m11.ps1")
$cs = Join-Path $scriptDir "m11-smoke.cjs"
$rs = Join-Path $scriptsRuntimeDir "m11-smoke.cjs"
...
& (Join-Path $scriptDir "stop-dev-m11.ps1")
