...
Write-Host "=== GlyphDeck m14 Settings + Release Smoke ==="
...
Write-Host "[harness] Starting m14 backend (release mode)..."
& (Join-Path $scriptDir "start-dev-m14.ps1")
$cs = Join-Path $scriptDir "m14-smoke.cjs"
$rs = Join-Path $scriptsRuntimeDir "m14-smoke.cjs"
...
& (Join-Path $scriptDir "stop-dev-m14.ps1")
