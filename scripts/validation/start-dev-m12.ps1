...
Start-Job -Name "glyphdeck-m12-frontend" -ScriptBlock { param($dir,$log) Set-Location $dir; cmd /c npm run dev >> $log 2>&1 } -Arg (Join-Path $repoRoot "web"),$frontendLog | Out-Null
