...
| Milestone 6 — Usage tab | Accepted | 3d03bea | Backend usage aggregation with `available`/`reason` fields; unavailable state in frontend; recovery smoke scripts with honesty rules |
